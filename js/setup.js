...
(function () {
  ...
  var setupSimilarListElement = document.querySelector('.setup .setup-similar-list');
  ...
  window.colorize(document.querySelector('.setup-wizard .wizard-coat'), wizardParams.COAT_COLORS, 'input[name="coat-color"]');
  window.colorize(document.querySelector('.setup-wizard .wizard-eyes'), wizardParams.EYES_COLORS, 'input[name="eyes-color"]');
  window.colorize(document.querySelector('.setup-fireball-wrap'), wizardParams.FIREBALL_COLORS, 'input[name="fireball-color"]');
})();
